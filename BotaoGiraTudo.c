...
//FIREBASE
const String firebaseHost = "https://firestore.googleapis.com/v1/projects/petcare2-7p7vtz/databases/(default)/documents/Esp32/zGpSQQTdpvIzQudhfSSA";
    ...
    // Porte pequeno 120g diárias
      ...
      case 2:
        ...
        digitalWrite(PinSTM32, LOW);
          ...
          //caso de teste da hora
          case 3:
          if (timeinfo.tm_hour == 14 && timeinfo.tm_min == 46 && timeinfo.tm_sec == 0) {
        digitalWrite(PinSTM32, HIGH);
        delay(TEMPO270);
        digitalWrite(PinSTM32, LOW);
        delay(TEMPOMEDIO);
        ...
        digitalWrite(PinSTM32, LOW);
          ...
          else if (timeinfo.tm_hour == 14 && timeinfo.tm_min == 47 && timeinfo.tm_sec == 0) {
        digitalWrite(PinSTM32, HIGH);
        delay(TEMPO270);
        digitalWrite(PinSTM32, LOW);
        delay(TEMPOMEDIO);
